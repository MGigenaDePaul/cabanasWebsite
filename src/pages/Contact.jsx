...
const channels = [
  ...
  },
  {
    ...
    label: 'Instagram',
    value: '@cab_5estrellas',
    subtitle: 'Seguinos y mirá nuestras fotos',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  },
  {
    ...
    label: 'Email',
    value: 'cabin5estrellas@gmail.com',
    subtitle: 'Para consultas formales',
    icon: (
  ...
  },
  {
    ...
    label: 'Ubicación',
    value: 'Sierras de Córdoba, Argentina',
          ...
          <div className="contact-grid">
            {channels.map(ch => (
              <a
                key={ch.id}
                href={ch.href}
                className={`contact-card contact-card--${ch.id}`}
              ...
              >
                ...
                <div className="contact-text">
                  ...
                  <span className="contact-subtitle">{ch.subtitle}</span>
                </div>
